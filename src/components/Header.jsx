      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-blue-900">IETE-PCE</h1>
              <p className="text-sm text-gray-600">Institution of Electronics and Telecommunication Engineers</p>
            </div>
          </div>
