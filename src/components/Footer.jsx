    ...
    <footer className="bg-blue-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-xl font-bold">IETE-PCE</h3>
            </div>
            <p className="text-gray-300 mb-4">
              The Institution of Electronics and Telecommunication Engineers (IETE) - PCE Chapter is 
              dedicated to advancing the field of Electronics, Telecommunication, and Information Technology 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/committee" className="text-gray-300 hover:text-white transition-colors">Committee</Link></li>
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-300">
              <div className="flex items-start space-x-2">
                ...
                <span>Pillai College of Engineering<br />Sector 16, New Panvel<br />Navi Mumbai, Maharashtra</span>
              </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-300">
          <p>&copy; 2025 IETE-PCE. All rights reserved. | Mahatma Education Society's Pillai College of Engineering</p>
        </div>
      </div>
    </footer>
  )
